...
export default function App() {
  ...
  const infoTrans = {
    ...
    en: {
      ...
      floatingHint: "Ask a Live Q&A Question"
    },
    ja: {
      qual: "法務部正式登録出入국대행기관＆職業紹介許可公認資格保有",
      rate: "事犯審査の高い救済率",
      floatingHint: "リアルタイムQ&Aで質問する"
    },
    zh: {
      qual: "法务부정식등록출입국대행기관 & 职业介绍许可公认资质拥有者",
      rate: "出入境违规审查救济率高",
      floatingHint: "在实时 Q&A 提问"
    },
    vi: {
      ...
      floatingHint: "Đặt câu hỏi Q&A trực tuyến"
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col relative" id="visa-friend-app-root">
      ...
      <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40 flex flex-col gap-2.5 md:gap-3">
        {/* Phone Quick Call */}
        <a
